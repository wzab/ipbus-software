...
#ifndef _uhal_ProtocolDirectPCIe_hpp_
#define _uhal_ProtocolDirectPCIe_hpp_
...
namespace uhal
{
  ...
  class DirectPCIe : public ClientInterface
  {
    ...
    public:
      ...
      */
      DirectPCIe ( const std::string& aId, const URI& aUri );
    ...
    protected:
      ...
      */
      ...
      virtual void implementDispatch(boost::shared_ptr<uhal::Buffers>) {}

      virtual  exception::exception* validate ( uint8_t* aSendBufferStart ,
          uint8_t* aSendBufferEnd ,
          std::deque< std::pair< uint8_t* , uint32_t > >::iterator aReplyStartIt ,
          std::deque< std::pair< uint8_t* , uint32_t > >::iterator aReplyEndIt ) {return NULL;}
    ...
    protected:
      ...
      /**
        ...
        @return the maximum number of packets in flight
      */
      virtual uint32_t getMaxNumberOfBuffers() {return 1;}
      /**
        Return the maximum size to be sent based on the buffer size in the target
        @return the maximum size to be sent
      */
      virtual uint32_t getMaxSendSize() {return 1500;}
      /**
        Return the maximum size of reply packet based on the buffer size in the target
        @return the maximum size of reply packet
      */
      virtual uint32_t getMaxReplySize() {return 1500;}
